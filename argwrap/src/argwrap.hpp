...
namespace td
{
    namespace impl
    {
        ...
        std::tuple<Args...> AsTuple(std::array<ArgWrap, N>& arr, std::index_sequence<Is...>)
        {
    ...
    public:
        ...
        explicit FuncWrap(void (*func)(Args...))
        {
            ...
            m_function    = [func](void* args_ptr) {
                auto& args = *static_cast<std::array<impl::ArgWrap, sizeof...(Args)>*>(args_ptr);
        ...
        void Invoke(Args&&... args)
        {
            ...
            std::array<impl::ArgWrap, sizeof...(Args)> args_arr = {impl::ArgWrap {std::forward<Args>(args)}...};
            m_function(&args_arr);
        }
